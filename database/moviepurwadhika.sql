...
INSERT INTO `categories` VALUES (1,'Action'),(2,'Drama'),(3,'Action-Thrillerrr'),(7,'Horror-Thriller');
...
CREATE TABLE `movcat` (
  ...
  CONSTRAINT `fk_catid_to_movcat_catid` FOREIGN KEY (`idcategory`) REFERENCES `categories` (`id`) ON DELETE CASCADE
...
INSERT INTO `movcat` VALUES (0,1),(1,1),(3,1),(2,1),(2,3);
...
-- Dump completed on 2019-08-21 11:26:32
